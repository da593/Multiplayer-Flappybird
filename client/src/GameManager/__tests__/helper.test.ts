...
import { calculateBirdCoords, calculateGapCoords, calculateNewBirdCoords, calculateNewGapCoords, detectCollision } from "GameManager/helper";
import* as randomizeGapFunc from "GameManager/randomizeGapFunc";
...
describe("test detect collision function", () => {
...
describe("test gap coordinates calculations", () => {
    ...
    test("calculate new gap coordinates given previous coordinates", () => {
        ...
        const spy = jest.spyOn(randomizeGapFunc, 'randomizeYGapLocation');
        spy.mockReturnValue(350);
        const mockYGapLocation = randomizeGapFunc.randomizeYGapLocation();
        expect(mockYGapLocation).toEqual(350);

        spy.mockRestore();
    });
})

describe("test bird coordinates calculations", () => {
