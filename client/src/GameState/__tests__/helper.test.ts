...
import { calculateBirdCoords, calculateGapCoords, calculateNewBirdCoords, calculateNewGapCoords, detectCollision } from "GameState/helper";
import* as randomizeGapFunc from "GameState/randomizeGapFunc";
